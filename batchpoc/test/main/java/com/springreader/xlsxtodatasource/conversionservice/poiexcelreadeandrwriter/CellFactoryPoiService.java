...
import com.springreader.xlsxtodatasource.exception.UnknownCellTypeException;
 ...
 * @author aek
 */
public class CellFactoryPoiService {
    ...
    static {
        ...
        EXCEL_CELL_VALUE.put(CellType.NUMERIC, Cell::getNumericCellValue);
