...
import com.springreader.xlsxtodatasource.exception.ExcelFileException;
 ...
 */
public abstract class ExcelPoiAbstractService<T> {

    private static final Logger LOGGER = Logger.getLogger(ExcelPoiAbstractService.class.getName());
     ...
     * @param rowMapper RowMapperService object
     * @return list of <T>
     */
    public List<T> read(String filePathStr, final RowMapperService<T> rowMapper) {
                ...
                sheet.forEach(row -> {
                    ...
                    if (row.getRowNum() != 0){
                        try {
                            ...
                            LOGGER.log(Level.WARNING, "RowMapperService Parse exception");
                        }
                    }
                });
